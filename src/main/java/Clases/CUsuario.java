...
public class CUsuario {
    ...
    public void AgregarUsuario(JTextField nombres, JTextField apellido, JComboBox combosexo, JTextField edad, JDateChooser fnacimiento, File foto){
        
        CConexion objetoConexion = new CConexion();
        String consulta = "insert into usuarios (nombres, apellido, fksexo, edad, fnacimiento, foto)values (?,?,?,?,?,?);";
    ...
    public void MostrarUsuarios(JTable tablaTotalUsuarios){
        ...
        sql="select usuarios.id, usuarios.nombres, usuarios.apellido, sexo.sexo, usuarios.edad, usuarios.fnacimiento, usuarios.foto from usuarios INNER JOIN sexo ON usuarios.fksexo = sexo.id;";
        ...
        try{
            ...
            while (rs.next()){
                ...
                if (imageBytes !=null){
                    ...
                    modelo.addRow(new Object[]{id, nombres, apellido, sexo, edad, nuevaFecha, foto});
        ...
        public void Seleccionar(JTable totalUsuarios, JTextField id, JTextField nombres, JTextField apellido, JComboBox sexo, JTextField edad, JDateChooser fnacimiento, JLabel foto){
        ...
        public void ModificarUsuario(JTextField id, JTextField nombres, JTextField apellido, JComboBox combosexo, JTextField edad, JDateChooser fnacimiento, File foto){
             CConexion objetoConexion = new CConexion();
        ...
        public void ElimiarUsuario(JTextField id){
        CConexion objetoConexion = new CConexion();
        ...
        String consulta = "DELETE FROM usuarios WHERE usuarios.id=?;";
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "Se eliminó correctamente");
                        ...
                        JOptionPane.showMessageDialog(null, "No se elminó correctamente, error: " + e.toString());
             } 
        ...
        public void limpiarCampos(JTextField id, JTextField nombres, JTextField apellido, JTextField edad, JDateChooser fnacimiento, JTextField rutaimagen, JLabel imagencontenido){
